...
const FilterSidebar = () => {
    ...
    return (
        <div className='p-4'>
            ...
            <div className="mb-6">
                <label htmlFor="color" className='block text-gray-600 font-medium mb-2'>Colors</label>
            ...
            <div className="mb-6">
                <label htmlFor="material" className='block text-gray-600 font-medium mb-2'>Materials</label>
            ...
            <div className="mb-6">
                <label htmlFor="brand" className='block text-gray-600 font-medium mb-2'>Brands</label>
                {brands.map((brand) => (
