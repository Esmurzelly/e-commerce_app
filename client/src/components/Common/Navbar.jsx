            ...
            <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
                ...
                <div className='flex items-center space-x-4'>
                    <Link to={`/profile`} className=''>
                        <HiOutlineUser className='h-6 w-6 text-gray-700 hover:text-rabbit-red' />
                    </Link>
                    ...
                    <button className='md:hidden' onClick={toggleNavtDrawer}>
            ...
            <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <div className="p-4">
                    ...
                    <nav className='space-y-4'>
                        <Link to={'#'} onClick={toggleNavtDrawer} className='block text-gray-600 hover:text-black'>Men</Link>
                        <Link to={'#'} onClick={toggleNavtDrawer} className='block text-gray-600 hover:text-black'>Women</Link>
                        <Link to={'#'} onClick={toggleNavtDrawer} className='block text-gray-600 hover:text-black'>Top Wear</Link>
                        <Link to={'#'} onClick={toggleNavtDrawer} className='block text-gray-600 hover:text-black'>Bottom Wear</Link>
                    </nav>
                </div>
            </div>
        </>
