            ...
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
                <div className='lg:w-1/2 p-8 text-center lg:text-left'>
                    ...
                    <p className='text-lg text-gray-600 mb-6'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus sit et aliquid possimus eum
                        voluptatum, commodi magni perspiciatis doloribus odio pariatur numquam perferendis necessitatibus
                        hic!
                    </p>
                ...
                <div className='lg:w-1/2'>
                    <img src={featuredImg} alt="featured" className='w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl' />
                </div>
            </div>
